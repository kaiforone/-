...
class Trade:
	def __init__(self, symbol, data, trade_amount, trade_strategy, capital, start_date = '1900-01-01', end_date = '2099-01-01'):
		self.symbol = symbol
		self.data = data
...
if __name__ == '__main__':
	...
	trade = Trade('20221231', dfcf_df, 100, 'right_attack', 100000, '20011101','20221231')
	trade.main()
	print(trade.account.asset)
